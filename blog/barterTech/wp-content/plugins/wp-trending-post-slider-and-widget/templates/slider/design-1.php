<div id="wtpsw-slider-<?php echo $unique; ?>" class="wtpsw-post-slider-<?php echo $unique; ?> wtpsw-post-slider <?php echo $design; ?>" data-conf="<?php echo htmlspecialchars(json_encode($slider_conf)); ?>">
