...
<div class="wrap">
	...
	<h2><?php _e( 'WP Trending Post Slider and Widget - Features', 'wtpsw' ); ?></h2><br />
	...
	<table class="wpos-plugin-pricing-table">
		...
		<thead>
			<tr>
				...
				<th>
					<h2>Premium</h2>
					<p>Gain access to <strong>WP Trending Post Slider and Widget</strong> and <strong>all other products</strong> with a single purchase.</p>
		...
		<tfoot>
			<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>Trending/Popular Post Slider and Widget</strong> and <strong>all other products</strong> with a single purchase.</p>
